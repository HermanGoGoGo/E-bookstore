...
<head>
  <meta charset="utf-8">
    ...
    <meta http-equiv="Refresh" content="0; URL=<%=path%>/home/toHomePage.action">
    <link rel="icon" href="<%=path%>/images/favicon.ico">

    <title>e书网 - 正在加载中 </title>
		  ...
		  <div class="row h-p100 align-items-center justify-content-center text-center">
			  <div class="col-lg-7 col-md-10 col-12">
				  <div class="b-double border-gray rounded bg-secondary">
					  ...
					  <h1>欢迎进入e书网！</h1>
					  <h4 class="mb-25"><i class="fa fa-hand-o-down"></i>加载过长可点击下方按钮<i class="fa fa-hand-o-down"></i></h4>	
